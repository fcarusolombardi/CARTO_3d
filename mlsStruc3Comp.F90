...
!     apex position + offset
      ...
      do ntr = 1, nvtot_3d
        ...
        !        fsmth = 1.d0
        fsmth=LabelSmooth(ntr) !FV RIGUARDA QUESTO
       ...
       xyza_3d(3,ntr) = (fpxyz_3d(3,ntr) + fxyz_3d(3,ntr)) * dinvm
        ...
        xyzv_3d(2,ntr) = 0.0D0
        xyzv_3d(3,ntr) = 0.0D0
        xyz_3d(1,ntr) = xyz_3d(1,ntr)
        xyz_3d(2,ntr) = xyz_3d(2,ntr)
        xyz_3d(3,ntr) = xyz_3d(3,ntr)
#else
        xyzv_3d(1,ntr) =      fsmth * (xyzv_3d(1,ntr) + (xyza_3d(1,ntr) * (1.d0 + 0.5d0*dtr) - &
                              xyza0_3d(1,ntr) * (0.5d0*dtr)) * dt)
        xyzv_3d(2,ntr) =      fsmth * (xyzv_3d(2,ntr) + (xyza_3d(2,ntr) * (1.d0 + 0.5d0*dtr) - &
                              xyza0_3d(2,ntr) * (0.5d0*dtr)) * dt)
        xyzv_3d(3,ntr) =      fsmth * (xyzv_3d(3,ntr) + (xyza_3d(3,ntr) * (1.d0 + 0.5d0*dtr) - &
                              xyza0_3d(3,ntr) * (0.5d0*dtr)) * dt)

        xyz_3d(1,ntr) = xyz_3d(1,ntr) + (xyzv_3d(1,ntr) * (1.d0 + 0.5d0*dtr) - &
                   xyzv0_3d(1,ntr) * (0.5d0*dtr)) * dt
        xyz_3d(2,ntr) = xyz_3d(2,ntr) + (xyzv_3d(2,ntr) * (1.d0 + 0.5d0*dtr) - &
                   xyzv0_3d(2,ntr) * (0.5d0*dtr)) * dt
        xyz_3d(3,ntr) = xyz_3d(3,ntr) + (xyzv_3d(3,ntr) * (1.d0 + 0.5d0*dtr) - &
...
!boundary condition 3d
      ...
      do i = 1,count2_3d
        ...
        if (v2.LT.0) then
           ...
           xyzv_3d(2,v1) = 0.d0
           xyzv_3d(3,v1) = 0.d0
           xyz_3d(1,v1) = xyz0_3d(1,v1)
           xyz_3d(2,v1) = xyz0_3d(2,v1)
           xyz_3d(3,v1) = xyz0_3d(3,v1)
        else !it shouldn't enter here
           xyza_3d(1,v1) = xyza_3d(1,v2)
           xyza_3d(2,v1) = xyza_3d(2,v2)
           xyza_3d(3,v1) = xyza_3d(3,v2)
           xyzv_3d(1,v1) = xyzv_3d(1,v2)
           xyzv_3d(2,v1) = xyzv_3d(2,v2)
           xyzv_3d(3,v1) = xyzv_3d(3,v2)
           xyz_3d(1,v1) = xyz_3d(1,v2)+BCoffset_3d(1,i)   
           xyz_3d(2,v1) = xyz_3d(2,v2)+BCoffset_3d(2,i)   
           xyz_3d(3,v1) = xyz_3d(3,v2)+BCoffset_3d(3,i)   
        endif
      end do
!--------------------------------------------------------------------
...
!     apex position + offset
      ...
      do ntr = nvstart_2dstr,nvend_2dstr
        ...
        xyz(3,ntr) = xyz(3,ntr)
#else
        xyzv(1,ntr) = fsmth * (xyzv(1,ntr) + (xyza(1,ntr) * (1.d0 + 0.5d0*dtr) - &
                              xyza0(1,ntr) * (0.5d0*dtr)) * dt)
        xyzv(2,ntr) = fsmth * (xyzv(2,ntr) + (xyza(2,ntr) * (1.d0 + 0.5d0*dtr) - &
                              xyza0(2,ntr) * (0.5d0*dtr)) * dt)
        xyzv(3,ntr) = fsmth * (xyzv(3,ntr) + (xyza(3,ntr) * (1.d0 + 0.5d0*dtr) - &
                              xyza0(3,ntr) * (0.5d0*dtr)) * dt)

        xyz(1,ntr) = xyz(1,ntr) + (xyzv(1,ntr) * (1.d0 + 0.5d0*dtr) - &
                   xyzv0(1,ntr) * (0.5d0*dtr)) * dt
        xyz(2,ntr) = xyz(2,ntr) + (xyzv(2,ntr) * (1.d0 + 0.5d0*dtr) - &
                   xyzv0(2,ntr) * (0.5d0*dtr)) * dt
        xyz(3,ntr) = xyz(3,ntr) + (xyzv(3,ntr) * (1.d0 + 0.5d0*dtr) - &
...
!boundary condition 2d
      ...
      do i = 1,count2
        ...
        if (v2.LT.0) then
           ...
           xyza(2,v1) = xyza(2,v2)
           xyza(3,v1) = xyza(3,v2)
           xyzv(1,v1) = xyzv(1,v2) !now slaved again to 2d
           xyzv(2,v1) = xyzv(2,v2)
           xyzv(3,v1) = xyzv(3,v2)
           xyz(1,v1) = xyz(1,v2)+BCoffset(1,i)   
           xyz(2,v1) = xyz(2,v2)+BCoffset(2,i)   
           xyz(3,v1) = xyz(3,v2)+BCoffset(3,i)   
        endif
      end do
!--------------------------------------------------------------------
...
#ifdef CONTACT
      call ContactModel(1,nvtot,xyz,xyzv)
#endif
#ifdef CONTACTV
      call ContactModelV(1,nvtot,xyz,xyzv)
#endif
      call nvtxEndRange
