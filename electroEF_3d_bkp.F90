...
!do i=vstart_3d(1),vend_3d(1)
       ...
       do j=1,n_cell_of_vert_3d(i)
            ...
            if (cell_to_chamb_3d(c1).ne.9) then !MOD_BC
               xC1 = cell_bar(1,c1)
               yC1 = cell_bar(2,c1)
               zC1 = cell_bar(3,c1)
...
!spatial term
        ...
        do j=1,4
           ...
           if ((cell_to_chamb_3d(c1).ne.9).and.(cell_to_chamb_3d(c2).ne.9)) then !MOD_BC
              bordo = bordo + &
...
!           Dij = 0.168D0 !mm^2/ms !Parameter Fig. 3c
        ...
        if ((epi_endo_mur.NE.1).and.(epi_endo_mur.NE.2)) then
           epi_endo_mur = 2
        endif
        CONST4 = -83;
        CONST5 = 2.7;
...
!!!!!!!!!!!!
      ...
      do i=cstart_3d(1),cend_3d(1)
         ...
         if ((chamb.eq.1).or.(chamb.eq.3)) then
            ...
            if ((distveG2.LT.(5.0D0/(1000.D0*LSTAR))).and.(scar_cell(i).ne.2)) then
!               IstimEF_3d(i)=-60.D0
               IstimEF_3dS1(i)=-1.D0 !minimal stimolo
            endif
            distveG2=sqrt((xBc-xS2)**2+(yBc-yS2)**2+(zBc-zS2)**2)
            if ((distveG2.LT.(15.0D0/(1000.D0*LSTAR))).and.(scar_cell(i).ne.2)) then 
!               IstimEF_3d(i)=-60.D0
               IstimEF_3dS2(i)=-1.D0 !minimal stimolo
            endif
         endif
