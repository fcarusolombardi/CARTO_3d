...
!=====================================================
!  temperature
      subroutine interp_dens(kstarto,kendo)
      use param
      use mpih
...
!    setup old new grids
      ...
      if(kstarto.le.1) then
        do i=1,n1o
          do j=1,n2o
            varold(i,j,0)=densbot
          enddo
        enddo
      endif
      if(kendo.ge.n3om) then
        do i=1,n1o
          do j=1,n2o
            varold(i,j,n3o)=denstop
          enddo
        enddo
      endif
