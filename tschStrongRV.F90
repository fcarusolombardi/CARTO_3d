...
!     Compute pressure and viscous loads
        ...
        call mlsStrucPredictorNewtonRV(1)
        call nvtxEndRange
...
!     Compute pressure and viscous loads
        call nvtxStartRange("mlsStruc", 29)
        call mlsStrucPredictorNewtonRV(2)
        call nvtxEndRange
...
!store stuff
      ...
      do ntr = 1, nvtot_3d
         ...
         xyzak_3d(1,ntr)=xyza_3d(1,ntr)
         xyzak_3d(2,ntr)=xyza_3d(2,ntr)
         xyzak_3d(3,ntr)=xyza_3d(3,ntr)
      ...
      do ntr = nvstart_2dstr,nvend_2dstr
         ...
         xyzak(1,ntr)=xyza(1,ntr)
         xyzak(2,ntr)=xyza(2,ntr)
         xyzak(3,ntr)=xyza(3,ntr)
...
!================================
        ...
        call mlsStruc3CompStrong !LOADS

        call mlsStrucCorrectorNewtonRV
