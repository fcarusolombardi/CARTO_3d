      subroutine mlsStrucCorrectorNewton
      USE mpih
      USE param
      USE mls_param
...
!         else
        ...
        xyzauk_3d(1,ntr)=(1.0-undr)*xyzak_3d(1,ntr)+undr*xyzakm1_3d(1,ntr)
        xyzauk_3d(2,ntr)=(1.0-undr)*xyzak_3d(2,ntr)+undr*xyzakm1_3d(2,ntr)
        xyzauk_3d(3,ntr)=(1.0-undr)*xyzak_3d(3,ntr)+undr*xyzakm1_3d(3,ntr)
        ...
        xyzvkp1_3d(3,ntr) = fsmth3*fsmth * (xyzv_3d(3,ntr) + ( (xyzauk_3d(3,ntr) + xyza_3d(3,ntr) )* (0.5d0*dtr)) * dt)


        xyzvuk_3d(1,ntr)=(1.0-undr)*xyzvk_3d(1,ntr)+undr*xyzvkm1_3d(1,ntr)
        xyzvuk_3d(2,ntr)=(1.0-undr)*xyzvk_3d(2,ntr)+undr*xyzvkm1_3d(2,ntr)
        xyzvuk_3d(3,ntr)=(1.0-undr)*xyzvk_3d(3,ntr)+undr*xyzvkm1_3d(3,ntr)


        xyzkp1_3d(1,ntr) = xyz_3d(1,ntr) + ( (xyzvuk_3d(1,ntr) + xyzv_3d(1,ntr) )* (0.5d0*dtr)) * dt
        xyzkp1_3d(2,ntr) = xyz_3d(2,ntr) + ( (xyzvuk_3d(2,ntr) + xyzv_3d(2,ntr) )* (0.5d0*dtr)) * dt
        xyzkp1_3d(3,ntr) = xyz_3d(3,ntr) + ( (xyzvuk_3d(3,ntr) + xyzv_3d(3,ntr) )* (0.5d0*dtr)) * dt
...
!          else
        ...
        xyzauk(1,ntr)=(1.0-undr)*xyzak(1,ntr)+undr*xyzakm1(1,ntr)
        xyzauk(2,ntr)=(1.0-undr)*xyzak(2,ntr)+undr*xyzakm1(2,ntr)
        xyzauk(3,ntr)=(1.0-undr)*xyzak(3,ntr)+undr*xyzakm1(3,ntr)
        ...
        xyzvuk(1,ntr)=(1.0-undr)*xyzvk(1,ntr)+undr*xyzvkm1(1,ntr)
        xyzvuk(2,ntr)=(1.0-undr)*xyzvk(2,ntr)+undr*xyzvkm1(2,ntr)
        xyzvuk(3,ntr)=(1.0-undr)*xyzvk(3,ntr)+undr*xyzvkm1(3,ntr)


        xyzkp1(1,ntr) = xyz(1,ntr) + ( (xyzvuk(1,ntr) + xyzv(1,ntr) )* (0.5d0*dtr)) * dt
        xyzkp1(2,ntr) = xyz(2,ntr) + ( (xyzvuk(2,ntr) + xyzv(2,ntr) )* (0.5d0*dtr)) * dt
        xyzkp1(3,ntr) = xyz(3,ntr) + ( (xyzvuk(3,ntr) + xyzv(3,ntr) )* (0.5d0*dtr)) * dt
